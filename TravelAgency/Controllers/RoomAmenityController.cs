...
namespace TravelAgency.Controllers
{
    ...
    {
        private readonly IEntityBaseRepository<RoomAmenity> _rep;

        public RoomAmenityController(IEntityBaseRepository<RoomAmenity> rep)
        {
            _rep = rep;
        }
        ...
        {
            return View(new RoomAmenity());
        }

        [HttpPost]
        public async Task<IActionResult> Create(RoomAmenity item)
        {
            if (item == null)
            {
                return View(item);
        ...
        [HttpPost]
        public async Task<IActionResult> Edit(RoomAmenity item)
        {
